      ...
      <div className="bg-[#faf8f3] border border-[#e8e0d0] p-6">
        ...
        <div className="flex items-center justify-center h-64">
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-[#7a6a4a]">Generating forecast...</p>
          </div>
        </div>
      </div>
    );
      ...
      {forecastData && (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {/* Expected Sales */}
            <div className="bg-white border border-[#e8e0d0] p-5">
              <div className="text-sm text-[#7a6a4a] mb-2">Expected Sales</div>
              <div className="text-2xl font-bold text-[#d4af37]">
                {formatCurrency(forecastData.predictedSales)}
              </div>
              <div className="text-xs text-[#7a6a4a] mt-1">{forecastData.period}</div>
            </div>

            {/* Expected Orders */}
            <div className="bg-white border border-[#e8e0d0] p-5">
              <div className="text-sm text-[#7a6a4a] mb-2">Expected Orders</div>
              <div className="text-2xl font-bold text-[#d4af37]">
            ...
            {/* Trend */}
            <div className="bg-white border border-[#e8e0d0] p-5">
              <div className="text-sm text-[#7a6a4a] mb-2">Sales Trend</div>
              <div
              ...
              <div className="text-xs text-[#7a6a4a] mt-1">Based on history</div>
            </div>
          </div>
          ...
          <div className="bg-white border border-[#e8e0d0] p-5">
            ...
            <div className="space-y-2 text-[#1c1810]">
              <p>
          ...
          <div className="bg-white border border-[#e8e0d0] p-5">
            ...
            <div className="mt-4 flex items-center justify-center gap-6 text-sm">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[#1c1810]">Past Sales</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 rounded-full bg-green-500"></div>
                <span className="text-[#1c1810]">Predicted Sales</span>
              </div>
            </div>
          </div>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-[#e8e0d0]">
                    <th className="text-left py-2 text-[#7a6a4a]">Month</th>
                    <th className="text-right py-2 text-[#7a6a4a]">Expected Sales</th>
                  </tr>
                </thead>
                <tbody>
                  {forecastData.monthlyBreakdown.map((item, index) => (
                    <tr key={index} className="border-b border-[#d4af37]/10">
                      <td className="py-2 text-[#1c1810]">{item.month}</td>
