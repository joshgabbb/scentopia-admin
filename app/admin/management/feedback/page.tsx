      ...
      channel = supabase
        ...
        .on(
          ...
          (payload) => {
            ...
            // Auto-refresh if on first page with no filters
          ...
          <div className="bg-[#faf8f3] border border-[#e8e0d0] max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b border-[#e8e0d0]">
              <div className="flex justify-between items-start">
                ...
                <button onClick={() => setSelectedFeedback(null)} className="text-[#7a6a4a] hover:text-[#1c1810]">
                  ✕
                </button>
              </div>
            </div>
      ...
      {totalPages > 1 && (
        <div className="flex justify-center gap-2">
          <button
            ...
            className="px-4 py-2 border border-[#e8e0d0] text-[#1c1810] disabled:opacity-50 hover:border-[#d4af37]/50"
          >
            Previous
          </button>
